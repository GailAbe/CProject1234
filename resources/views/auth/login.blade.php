                            ...
                            <form class="form" id="kt_login_signin_form">
                                <div class="form-group">
                                    <input type="text" placeholder="Username" name="user_name" autocomplete="off"
                                        class="form-control h-auto text-black bg-white rounded-pill border-0 py-4 px-8 @error('user_name') is-invalid @enderror" />
                                    @error('user_name')
                                ...
                                <div class="form-group">
                                    <input type="password" placeholder="Password" name="password"
                                        class="form-control h-auto text-black bg-white rounded-pill border-0 py-4 px-8 @error('password') is-invalid @enderror" />
                                    @error('password')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
